...
from PhysicsTools.NanoTuples.hwwTagger.pfMassDecorrelatedInclParticleTransformerV1DiscriminatorsJetTags_cfi import pfMassDecorrelatedInclParticleTransformerV1DiscriminatorsJetTags

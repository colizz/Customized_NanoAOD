...
pfMassDecorrelatedInclParticleTransformerV2JetTags = boostedJetONNXJetTagsProducer.clone(
    ...
    preprocess_json = 'PhysicsTools/NanoTuples/data/InclParticleTransformer-MD/ak8/V02-N/preprocess_corr.json',
    model_path = 'PhysicsTools/NanoTuples/data/InclParticleTransformer-MD/ak8/V02-N/model.onnx',
    flav_names = [
